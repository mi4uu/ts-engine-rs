...
var PrivateKey = /*#__PURE__*/function () {
  ...
  */
  ...
  PrivateKey.fromWif = function fromWif(_private_wif) {
    ...
    _assert["default"].equal(0x80, version, "Expected version " + 0x80 + ", instead got " + version);
  ...
  */;
  ...
  _proto.get_shared_secret = function get_shared_secret(public_key, legacy) {
    ...
    var KBP = _ecurve.Point.fromAffine(secp256k1, _bigi["default"].fromBuffer(KB.slice(1, 33)),
    // x
...
var _default = exports["default"] = PrivateKey;
