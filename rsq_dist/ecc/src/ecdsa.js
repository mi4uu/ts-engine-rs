...
function deterministicGenerateK(curve, hash, d, checkSig, nonce) {
  ...
  // Step H2b
  v = (0, _hash.HmacSHA256)(v, k);
  var T = _bigi["default"].fromBuffer(v);
...
function recoverPubKey(curve, e, signature, i) {
  ...
  (0, _assert["default"])(s.signum() > 0 && s.compareTo(n) < 0, "Invalid s value");
  ...
  var nR = R.multiply(n);
  (0, _assert["default"])(curve.isInfinity(nR), "nR is not a valid curve point");
