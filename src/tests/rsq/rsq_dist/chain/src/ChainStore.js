...
var _rsquaredJsWs = require("@r-squared/rsquared-js-ws");
...
var ChainStore = /*#__PURE__*/function () {
  ...
  _proto.init = function init(subscribe_to_new) {
    ...
    var _init2 = function _init(resolve, reject) {
      if (_this.subscribed) return resolve();
      var db_api = _rsquaredJsWs.Apis.instance().db_api();
      if (!db_api) {
        ...
        for (var i = 0; i < optional_objects.length; i++) {
          ...
          if (optional_object) {
            ...
            */
            ...
            if (delta < 60) {
              _rsquaredJsWs.Apis.instance().db_api().exec("set_subscribe_callback", [_this.onUpdate.bind(_this), subscribe_to_new]).then(function () {
              ...
              setTimeout(_init2.bind(_this, resolve, reject), 1000);
            }
          } else {
            setTimeout(_init2.bind(_this, resolve, reject), 1000);
          }
  ...
  _proto.getAsset = function getAsset(id_or_symbol) {
    ...
    _rsquaredJsWs.Apis.instance().db_api().exec("lookup_asset_symbols", [[id_or_symbol]]).then(function (asset_objects) {
  ...
  _proto.getAccountRefsOfKey = function getAccountRefsOfKey(key) {
    ...
    if (this.get_account_refs_of_keys_calls.has(key)) return this.account_ids_by_key.get(key);else {
      ...
      _rsquaredJsWs.Apis.instance().db_api().exec("get_key_references", [[key]]).then(function (vec_account_id) {
  ...
  _proto.getAccountRefsOfAccount = function getAccountRefsOfAccount(account_id) {
    ...
    if (this.get_account_refs_of_accounts_calls.has(account_id)) return this.account_ids_by_account.get(account_id);else {
      ...
      _rsquaredJsWs.Apis.instance().db_api().exec("get_account_references", [account_id]).then(function (vec_account_id) {
        var refs = _immutable["default"].Set();
        refs = refs.withMutations(function (r) {
          for (var i = 0; i < vec_account_id.length; ++i) {
            r.add(vec_account_id[i]);
  ...
  _proto.getBalanceObjects = function getBalanceObjects(address) {
    ...
    if (current === undefined) {
      ...
      _rsquaredJsWs.Apis.instance().db_api().exec("get_balance_objects", [[address]]).then(function (balance_objects) {
        var set = new Set();
  ...
  _proto.fetchObject = function fetchObject(id, force, autosubscribe, no_full_account) {
    ...
    if (typeof id !== "string") {
      var _result = [];
      for (var i = 0; i < id.length; ++i) _result.push(this.fetchObject(id[i], force, autosubscribe));
      return _result;
    }
    ...
    if (result === undefined) {
      ...
      if (!_rsquaredJsWs.Apis.instance().db_api()) return null;
      _rsquaredJsWs.Apis.instance().db_api().exec("get_objects", [[id]]).then(function (optional_objects) {
        //if(DEBUG) console.log("... optional_objects",optional_objects ? optional_objects[0].id : null)
  ...
  _proto.fetchAllWorkers = function fetchAllWorkers() {
    var _this9 = this;
    return new Promise(function (resolve, reject) {
      _rsquaredJsWs.Apis.instance().db_api().exec("get_all_workers", []).then(function (workers_array) {
  ...
  _proto.fetchWitnessByAccount = function fetchWitnessByAccount(account_id) {
    var _this0 = this;
    return new Promise(function (resolve, reject) {
      _rsquaredJsWs.Apis.instance().db_api().exec("get_witness_by_account", [account_id]).then(function (optional_witness_object) {
        if (optional_witness_object) {
          _this0._subTo("witnesses", optional_witness_object.id);
          _this0.witness_by_account_id = _this0.witness_by_account_id.set(optional_witness_object.witness_account, optional_witness_object.id);
          var witness_object = _this0._updateObject(optional_witness_object, true);
          resolve(witness_object);
        } else {
          _this0.witness_by_account_id = _this0.witness_by_account_id.set(account_id, null);
          _this0.notifySubscribers();
          resolve(null);
        }
      }, reject);
    });
  ...
  _proto.fetchCommitteeMemberByAccount = function fetchCommitteeMemberByAccount(account_id) {
    var _this1 = this;
    return new Promise(function (resolve, reject) {
      _rsquaredJsWs.Apis.instance().db_api().exec("get_committee_member_by_account", [account_id]).then(function (optional_committee_object) {
        if (optional_committee_object) {
          _this1._subTo("committee", optional_committee_object.id);
          _this1.committee_by_account_id = _this1.committee_by_account_id.set(optional_committee_object.committee_member_account, optional_committee_object.id);
          var committee_object = _this1._updateObject(optional_committee_object, true);
          resolve(committee_object);
        } else {
          _this1.committee_by_account_id = _this1.committee_by_account_id.set(account_id, null);
          _this1.notifySubscribers();
          resolve(null);
        }
      }, reject);
    });
  ...
  _proto.requestAllDataForAccount = function requestAllDataForAccount(account_id, object_type) {
    ...
    if (current.toJS().more_data_available.balances && object_type == "balance") {
      _rsquaredJsWs.Apis.instance().db_api().exec("get_account_balances", [account_id, []]).then(function (balances) {
  ...
  _proto.fetchFullAccount = function fetchFullAccount(name_or_id, autosubscribe) {
    ...
    if (subChanged || !this.fetching_get_full_accounts.has(name_or_id) || Date.now() - this.fetching_get_full_accounts.get(name_or_id) > 5000) {
      ...
      _rsquaredJsWs.Apis.instance().db_api().exec("get_full_accounts", [[name_or_id], autosubscribe]).then(function (results) {
        if (results.length === 0) {
          if (is_object_id) {
            _this10.objects_by_id.set(name_or_id, null);
            _this10.notifySubscribers();
          } else if (is_account_name) {
            _this10.accounts_by_name.set(name_or_id, null);
            _this10.notifySubscribers();
          }
          return;
        }
        ...
        var account = full_account.account,
          ...
          htlcs_to = full_account.htlcs_to;
        if (!settle_orders) {
        ...
        /*
            ...
            */
        if (sub_to_objects.length) _rsquaredJsWs.Apis.instance().db_api().exec("get_objects", [sub_to_objects]);
        ...
        if (error && error.message === "Assert Exception: account: no such account") {
          ...
          if (is_object_id) _this10.objects_by_id["delete"](name_or_id);else _this10.accounts_by_name["delete"](name_or_id);
        }
      });
    }
    return undefined;
  ...
  _proto.fetchRecentHistory = function fetchRecentHistory(account, limit) {
    ...
    pending_request.promise = new Promise(function (resolve, reject) {
      _rsquaredJsWs.Apis.instance().history_api().exec("get_account_history", [account_id, most_recent, limit, start]).then(function (operations) {
        ...
        updated_history = updated_history.withMutations(function (list) {
          for (var i = 0; i < current_history.size; ++i) list.push(current_history.get(i));
        });
      ...
      case "call_order":
        ...
        if (call_account && call_account !== true) {
          ...
          if (!call_orders.has(object.id)) {
            ...
            _rsquaredJsWs.Apis.instance().db_api().exec("get_objects", [[object.id]]); // Force subscription to the object in the witness node by calling get_objects
          }
        }
        break;
      case "limit_order":
  ...
  _proto.getObjectsByVoteIds = function getObjectsByVoteIds(vote_ids) {
    ...
    if (missing.length) {
      ...
      _rsquaredJsWs.Apis.instance().db_api().exec("lookup_vote_ids", [missing]).then(function (vote_obj_array) {
  ...
  _proto.getEstimatedChainTimeOffset = function getEstimatedChainTimeOffset() {
    ...
    var median_offset = _immutable["default"].List(this.chain_time_offset).sort().get(Math.floor((this.chain_time_offset.length - 1) / 2));
    ...
    approvals.forEach(function (id) {
      ...
      if (impactedAccount && impactedAccount !== true) {
        ...
        if (!proposals.includes(objectId)) {
          ...
          _this13.objects_by_id.set(impactedAccount.get("id"), impactedAccount);
        }
      }
    });
    return didImpact;
  };
  _proto.getLiquidityPoolsByAssets = function getLiquidityPoolsByAssets(assetType, assetA, assetB, limit, startId) {
    var _this14 = this;
    if (assetType === void 0) {
      assetType = 'asset_a';
    }
    ...
    var ASSET_TYPE = ['asset_a', 'asset_b', 'both'];
    ...
    var methodName = METHOD_NAME[assetType];
    var params = [];
    switch (assetType) {
      case 'asset_a':
    ...
    return _rsquaredJsWs.Apis.instance().db_api().exec(methodName, params).then(function (result) {
      if (result.length > 0) {
        var tmp = [];
        result.forEach(function (pool) {
          pool.asset_a = _this14.getAsset(pool.asset_a);
          pool.asset_b = _this14.getAsset(pool.asset_b);
          pool.share_asset = _this14.getAsset(pool.share_asset);
          pool.dynamic_share_asset = _this14.getObject(pool.share_asset.get('dynamic_asset_data_id'));
          tmp.push(pool);
        });
        return _immutable["default"].fromJS(tmp);
      }
  ...
  _proto.getLiquidityPoolsByShareAsset = function getLiquidityPoolsByShareAsset(assets, subscribe) {
    var _this15 = this;
    if (subscribe === void 0) {
      subscribe = false;
    }
    return _rsquaredJsWs.Apis.instance().db_api().exec('get_liquidity_pools_by_share_asset', [assets, subscribe]).then(function (result) {
      if (result.length > 0) {
        var tmp = [];
        result.forEach(function (pool) {
          pool.asset_a = _this15.getAsset(pool.asset_a);
          pool.asset_b = _this15.getAsset(pool.asset_b);
          pool.share_asset = _this15.getAsset(pool.share_asset);
          pool.dynamic_share_asset = _this15.getObject(pool.share_asset.get('dynamic_asset_data_id'));
          tmp.push(pool);
        });
        return _immutable["default"].fromJS(tmp);
      }
...
var _default = exports["default"] = chain_store;
