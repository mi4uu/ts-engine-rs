...
var TransactionBuilder = /*#__PURE__*/function () {
  ...
  */;
  _proto.process_transaction = function process_transaction(cwallet, signer_pubkeys, broadcast) {
    ...
    if (_rsquaredJsWs.Apis.instance().chain_id !== wallet_object.get("chain_id")) return Promise.reject("Mismatched chain_id; expecting " + wallet_object.get("chain_id") + ", but got " + _rsquaredJsWs.Apis.instance().chain_id);
  ...
  _proto.finalize = function finalize() {
    ...
    return new Promise(function (resolve, reject) {
      ...
      if (_this2.expiration !== 0 && _this2.ref_block_num !== 0 && _this2.ref_block_prefix !== 0) {
        ...
        resolve(_rsquaredJsWs.Apis.instance().db_api().exec("get_objects", [["2.1.0"]]).then(function (r) {
          head_block_time_string = r[0].time;
          if (_this2.expiration === 0) _this2.expiration = base_expiration_sec() + _rsquaredJsWs.ChainConfig.expire_in_secs;
  ...
  */;
  ...
  _proto.get_type_operation = function get_type_operation(name, operation) {
    ...
    if (name === "proposal_create") {
      ...
      */
      ...
      operation.expiration_time || (operation.expiration_time = base_expiration_sec() + _rsquaredJsWs.ChainConfig.expire_in_secs_proposal);
      if (requiresReview && !operation.review_period_seconds) {
        operation.review_period_seconds = extraReview + Math.max(committee_min_review, 24 * 60 * 60 || _rsquaredJsWs.ChainConfig.review_in_secs_committee);
        /*
  ...
  _proto.update_head_block = function update_head_block() {
    return Promise.all([_rsquaredJsWs.Apis.instance().db_api().exec("get_objects", [["2.0.0"]]), _rsquaredJsWs.Apis.instance().db_api().exec("get_objects", [["2.1.0"]])]).then(function (res) {
      var g = res[0],
        r = res[1];
      head_block_time_string = r[0].time;
  ...
  _proto.set_required_fees = function set_required_fees(asset_id, removeDuplicates) {
    ...
    */
    ...
    promises.push(Promise.all(feeAssets.map(function (id) {
      return _rsquaredJsWs.Apis.instance().db_api().exec("get_required_fees", [operations, id]);
    }))["catch"](function (err) {
    ...
    if (feeAssets.length > 1 || feeAssets[0] !== "1.3.0") {
      ...
      */
      ...
      promises.push(_rsquaredJsWs.Apis.instance().db_api().exec("get_required_fees", [operations, "1.3.0"]));
      promises.push(_rsquaredJsWs.Apis.instance().db_api().exec("get_objects", [dynamicObjectIds]));
    }
  ...
  _proto.get_potential_signatures = function get_potential_signatures() {
    ...
    return Promise.all([_rsquaredJsWs.Apis.instance().db_api().exec("get_potential_signatures", [tr_object]), _rsquaredJsWs.Apis.instance().db_api().exec("get_potential_address_signatures", [tr_object])]).then(function (results) {
      return {
        pubkeys: results[0],
        addys: results[1]
      };
  ...
  _proto.get_required_signatures = function get_required_signatures(available_keys) {
    ...
    return _rsquaredJsWs.Apis.instance().db_api().exec("get_required_signatures", [tr_object, available_keys]).then(function (required_public_keys) {
  ...
  _proto.sign = function sign(chain_id) {
    if (chain_id === void 0) {
      chain_id = _rsquaredJsWs.Apis.instance().chain_id;
    }
    if (!this.tr_buffer) {
      throw new Error("not finalized");
    }
...
function _broadcast(was_broadcast_callback) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    _rsquaredJsWs.Apis.instance().network_api().exec("broadcast_transaction_with_callback", [function (res) {
      return resolve(res);
...
var _default = exports["default"] = TransactionBuilder;
