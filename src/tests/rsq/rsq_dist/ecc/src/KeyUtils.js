  ...
  */
  ...
  addresses: function addresses(pubkey, address_prefix) {
    if (address_prefix === void 0) {
      address_prefix = _rsquaredJsWs.ChainConfig.address_prefix;
    }
    var public_key = _PublicKey["default"].fromPublicKeyString(pubkey, address_prefix);
    // S L O W
    var address_string = [_address["default"].fromPublic(public_key, false, 0).toString(address_prefix),
    // btc_uncompressed
    _address["default"].fromPublic(public_key, true, 0).toString(address_prefix),
    // btc_compressed
    _address["default"].fromPublic(public_key, false, 56).toString(address_prefix),
    // pts_uncompressed
    _address["default"].fromPublic(public_key, true, 56).toString(address_prefix),
    // pts_compressed
